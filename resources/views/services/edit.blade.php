        ...
        <div class="row justify-content-center">
            <div class="col-md-12">
                <div class="row align-items-center my-4">
                    <div class="col">
                        <h2 class="h3 mb-0 page-title">Modifier Service</h2>
                    </div>
                    <div class="col-auto">
                        ...
                        <div class="row breadcrumbs-top">
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active">{{ __('Modifier Service') }}</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12">
                                ...
                                <select aria-label="Default select example" name="departement" id="departement" class="form-select mt-1">
                                    <option selected disabled>{{ $service->departement->nom ?? "vide"}}</option>
