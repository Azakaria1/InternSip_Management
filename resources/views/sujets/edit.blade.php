        ...
        <div class="row justify-content-center">
            <div class="col-md-12">
                <div class="row align-items-center my-4">
                    <div class="col">
                        <h2 class="h3 mb-0 page-title">{{ __('Modifier Sujet') }}</h2>
                    </div>
                    <div class="col-auto">
                        ...
                        <div class="row breadcrumbs-top">
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active">{{ __('Modifier Sujet') }}</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card shadow mb-4">
                    <div class="card-body">
                        {!! Form::model($sujet, ['method' => 'PATCH','route' => ['sujets.update', $sujet->id]]) !!}
