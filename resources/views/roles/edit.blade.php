        ...
        <div class="row justify-content-center">
            <div class="col-md-12">
                <div class="row align-items-center my-4">
                    <div class="col">
                        <h2 class="h3 mb-0 page-title">Modifier Rôle</h2>
                    </div>
                    <div class="col-auto">
                        ...
                        <div class="row breadcrumbs-top">
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active">{{ __('Modifier Rôle') }}</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-xs-12 col-sm-12 col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="name" disabled id="name" placeholder="{{ $role->name }}">
                                </div>
                            </div>
                            <div class="col-xs-12 col-sm-12 col-md-12">
                                <div class="form-group">
                            ...
                            <a class="btn btn-warning" href="{{ route('roles.index') }}"> {{ __('Annuler') }}</a>
                        </div>
                        </div>
                        {!! Form::close() !!}
                    </div>
