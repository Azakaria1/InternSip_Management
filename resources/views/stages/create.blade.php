        ...
        <div class="row justify-content-center">
            <div class="col-md-12">
                <div class="row align-items-center my-4">
                    <div class="col">
                            <h2 class="h3 mb-0 page-title">{{ __('Nouveau Stage') }}</h2>
                    </div>
                    <div class="col-auto">
                        ...
                        <div class="row breadcrumbs-top">
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active">{{ __('Nouveau Stage') }}</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card shadow mb-4">
                    <div class="card-body">
                        {!! Form::open(array('route' => 'stages.store','method'=>'POST')) !!}
                        <div class="col-xs-12 col-sm-12 col-md-12">
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" required class="form-control" name="date_debut" id="date_debut">
                            ...
                            <strong for="date_fin">Date de Fin</strong>
                                <input type="date" required class="form-control" name="date_fin" id="date_fin">
                            </div>
                            </div>
                            </div>
                            </div></div>
